...
const zh = {
  ...
  "head.quota.t": "额度查询",
  "head.quota.s": "读取 DSH 配置中的 API 列表，按类型查询余额与额度",
  "head.settings.t": "设置",
  ...
  // ===== 额度查询（DSH 配置驱动） =====
  "quota.source.title": "API 额度",
  "quota.source": "数据来源：{home} 下的 settings.yaml 与 .credentials.yaml",
  "quota.refreshAll": "全部刷新",
  "quota.loadingList": "正在读取 DSH 配置…",
  "quota.configNotFound": "未找到 DSH 配置（{path}）。请先安装并启动一次 DSH。",
  "quota.configFailed": "读取 DSH 配置失败。",
  "quota.emptyConfig": "DSH 配置中尚未配置任何 API。",
  "quota.privacyNote":
    "API Key 读取自 DSH 凭据文件，界面仅显示脱敏形式；Key 不会写入本应用，也不会出现在日志中。",
  "quota.protocolUnknown": "未知协议",
  "quota.keyMasked": "Key {k}",
  "quota.keyMissing": "未配置 Key（需在 DSH 中设置 {env}）",
  "quota.keyMissingNoEnv": "未配置 Key（需在 DSH 中设置 apiKeyEnv）",
  "quota.refresh": "刷新",
  "quota.refreshing": "查询中…",
  "quota.autoQuery": "查询额度",
  "quota.queryOff": "已关闭此 API 的查询；打开开关即可查询",
  "quota.tier.five_hour": "5 小时窗口",
  "quota.tier.weekly": "每周窗口",
  "quota.tier.monthly": "每月窗口",
  "quota.plan.usedOf": "已用 {used} / {total}",
  "quota.plan.reset": "重置于 {time}",
  "quota.total": "总可用余额",
  "quota.granted": "赠送余额",
  "quota.toppedUp": "充值余额",
  "quota.orTotal": "总额度",
  "quota.orUsed": "已用金额",
  "quota.orRemaining": "剩余额度",
  "quota.balance": "余额",
  "quota.lastSuccess": "最近成功查询：{time}",
  "quota.refreshFailed": "刷新失败：{reason}，以下为上次成功查询的结果",
  "quota.emptyResult": "该账户未返回任何余额信息",
  "quota.loading": "正在查询…",
  "quota.err.no_key": "未配置 API Key：请先在 DSH 中配置该 API 的凭据",
  "quota.err.unsupported": "该 API 类型暂不支持额度查询",
  "quota.err.config": "读取 DSH 配置失败，请重试",
  "quota.err.invalid_input": "API Key 无效（含空白、换行等非法字符）",
  "quota.err.auth_failed": "鉴权失败：Key 无效或已被撤销，请到对应平台确认",
  "quota.err.rate_limited": "请求受限：触发限流，请稍后重试",
  "quota.err.network": "网络错误或请求超时，请检查网络后重试",
  "quota.err.server": "服务异常，请稍后重试",
  "quota.err.bad_response": "响应格式异常，无法解析额度数据",
  "quota.err.unknown": "查询失败，请稍后重试",
...
const en: Record<MsgKey, string> = {
  ...
  "head.quota.t": "Quota",
  "head.quota.s": "List the APIs configured in DSH and check balances by provider type",
  ...
  // ===== Quota (driven by the DSH configuration) =====
  "quota.source.title": "API Quota",
  "quota.source": "Source: settings.yaml and .credentials.yaml under {home}",
  "quota.refreshAll": "Refresh All",
  "quota.loadingList": "Reading DSH configuration…",
  "quota.configNotFound": "DSH configuration not found ({path}). Install and run DSH once first.",
  "quota.configFailed": "Failed to read the DSH configuration.",
  "quota.emptyConfig": "No API is configured in the DSH configuration yet.",
  "quota.privacyNote":
    "API keys are read from DSH's credentials file and only shown masked; they are never written by this app or logged.",
  "quota.protocolUnknown": "Unknown protocol",
  "quota.keyMasked": "Key {k}",
  "quota.keyMissing": "No key configured (set {env} in DSH)",
  "quota.keyMissingNoEnv": "No key configured (set apiKeyEnv in DSH)",
  "quota.refresh": "Refresh",
  "quota.refreshing": "Querying…",
  "quota.autoQuery": "Query quota",
  "quota.queryOff": "Query is disabled for this API; toggle it on to query",
  "quota.tier.five_hour": "5-hour window",
  "quota.tier.weekly": "Weekly window",
  "quota.tier.monthly": "Monthly window",
  "quota.plan.usedOf": "Used {used} / {total}",
  "quota.plan.reset": "Resets {time}",
  "quota.total": "Total Balance",
  "quota.granted": "Granted Balance",
  "quota.toppedUp": "Topped-up Balance",
  "quota.orTotal": "Total Credits",
  "quota.orUsed": "Used",
  "quota.orRemaining": "Remaining",
  "quota.balance": "Balance",
  "quota.lastSuccess": "Last successful check: {time}",
  "quota.refreshFailed": "Refresh failed: {reason} — showing the last successful result below",
  "quota.emptyResult": "No balance info returned for this account",
  "quota.loading": "Querying…",
  "quota.err.no_key": "API key not configured: set the credential for this API in DSH first",
  "quota.err.unsupported": "Quota query is not supported for this API type",
  "quota.err.config": "Failed to read the DSH configuration — retry",
  "quota.err.invalid_input": "Invalid API key (contains whitespace, newlines or other illegal characters)",
  "quota.err.auth_failed": "Authentication failed: the key is invalid or revoked — verify it on the provider platform",
  "quota.err.rate_limited": "Rate limited: too many requests — retry later",
  "quota.err.network": "Network error or timeout — check your connection and retry",
  "quota.err.server": "Server error — retry later",
  "quota.err.bad_response": "Unexpected response format — cannot parse the quota data",
  "quota.err.unknown": "Query failed — retry later",
