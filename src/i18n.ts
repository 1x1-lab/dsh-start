...
const zh = {
  ...
  "head.quota.t": "DeepSeek 余额",
  "head.quota.s": "查询 DeepSeek API Key 的账户余额，独立于 DSH 进程",
  "head.settings.t": "设置",
  ...
  "quota.clear": "清除 Key",
  "quota.memoryNote":
    "Key 仅保存在本页面内存中，离开页面或退出应用后即被清除；不会写入磁盘、设置文件或日志。",
  "quota.result.title": "余额",
  "quota.dataFor": "Key {k}",
  "quota.total": "总可用余额",
  "quota.granted": "赠送余额",
  "quota.toppedUp": "充值余额",
  ...
  "quota.idle": "输入 API Key 后点击查询。查询独立于 DSH 进程，DSH 未启动时也可使用。",
  "quota.loading": "正在查询 DeepSeek 余额…",
  "quota.err.empty": "请先输入 API Key",
  "quota.err.invalid_input": "Key 无效：请检查是否复制完整，且不含空白、换行等字符",
  "quota.err.auth_failed": "鉴权失败：Key 无效或已被撤销，请到 DeepSeek 平台确认",
  "quota.err.rate_limited": "请求受限：触发限流，请稍后重试",
  "quota.err.network": "网络错误或请求超时，请检查网络后重试",
  "quota.err.server": "DeepSeek 服务异常，请稍后重试",
  "quota.err.bad_response": "响应格式异常，无法解析余额数据",
...
const en: Record<MsgKey, string> = {
  ...
  "head.quota.t": "DeepSeek Balance",
  "head.quota.s": "Check your DeepSeek API key balance — independent of the DSH process",
  ...
  "quota.clear": "Clear Key",
  "quota.memoryNote":
    "The key is kept only in this page's memory and is discarded when you leave the page or quit the app — never written to disk, settings or logs.",
  "quota.result.title": "Balance",
  "quota.dataFor": "Key {k}",
  ...
  "quota.idle": "Enter your API key and click Query. Works independently of the DSH process — DSH does not need to be running.",
  "quota.loading": "Querying DeepSeek balance…",
  "quota.err.empty": "Enter your API key first",
  "quota.err.invalid_input": "Invalid key: make sure it is copied in full and contains no whitespace or newlines",
  "quota.err.auth_failed": "Authentication failed: the key is invalid or revoked — verify it on the DeepSeek platform",
  ...
  "quota.err.server": "DeepSeek server error — retry later",
  "quota.err.bad_response": "Unexpected response format — cannot parse the balance data",
