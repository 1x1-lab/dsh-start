...
const zh = {
  ...
  "quota.granted": "赠送余额",
  "quota.toppedUp": "充值余额",
  "quota.available.ok": "✓ 余额可调用 API",
  "quota.available.bad": "余额不足以调用 API",
  "quota.orTotal": "总额度",
  "quota.orUsed": "已用金额",
...
const en: Record<MsgKey, string> = {
  ...
  "quota.available.ok": "✓ Balance available for API calls",
  "quota.available.bad": "Balance insufficient for API calls",
